...
});}var A=new Error("Promise.prototype.then: already has waiting or not pending !\n");if(b.debugType==="development"){console.warn(y);throw A;}else{if(!y.isRejected()&&typeof y._promiseState.failCallback==="function"){y.reject(A);
...
}var y=typeof C==="number"&&typeof z==="function"?4:typeof C==="number"?3:2,D=a(l.call(arguments,y)),B={};typeof C==="number"&&(B.timeout=C);typeof z==="function"&&(B.timeoutCallback=z);
...
}].concat(l.call(arguments)));};b.prototype.whenOneResolved=function(A,z,y){var x=this;return e.apply(null,[this,function(B){var C=j(B);return c(C[A])||!B[A]?new Error("target: ["+A+"] is not resolved:\narr.length: "+C.length+"\n"+C):C.slice();
